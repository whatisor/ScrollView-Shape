...
define(function(require, exports, module) {
    ...
    var Scroller = require('famous/Kviews/KScroller');
    ...
    function Scrollview(options) {
       ...
       // this.sync = new GenericSync(["mouse",'scroll', 'touch'], {direction : this.options.direction});
        this.sync = new GenericSync({
    	    "mouse"  : {},
    	    "touch"  : {},
    	    "scroll" : {direction : this.options.direction}
    	});
    ...
    Scrollview.DEFAULT_OPTIONS = {
        ...
        onUpdate:null//Karoshi: onUpdate
    };
    ...
    /**
     * Sets position of the physics particle that cont	rols Scrollview instance's "position"
     * @method setPosition
    ...
    Scrollview.prototype.goToPage = function goToPage(index) {
        ...
        var newNode;
        var curNode = this._node;
        var currentNodeSize = 0;
        var newNodeSize = 0;
        var newSpringPosition;
        if (index > this._currentIndex) {
            for (var i = this._currentIndex; i < index; i++) {
                ...
                if (!newNode){
                    ...
                    currentNodeSize += _nodeSizeForDirection.call(this, curNode);
                    newNodeSize += _nodeSizeForDirection.call(this, newNode);
                curNode = newNode;
            }
            if (newNode) {
                var currentPosition = this.getPosition();
                newSpringPosition = (currentPosition > currentNodeSize - TOLERANCE) ? currentNodeSize + newNodeSize : currentNodeSize;
                this._scroller.sequenceFrom(newNode);
                this._node = newNode;
                _setSpring.call(this, newSpringPosition, SpringStates.PAGE);
                _shiftOrigin.call(this, -currentNodeSize);
            ...
            if (newNode) {
                var currentPosition = this.getPosition();
                newSpringPosition = (currentPosition < TOLERANCE) ? -newNodeSize : 0;
                this._scroller.sequenceFrom(newNode);
                this._node = newNode;
                _setSpring.call(this, newSpringPosition, SpringStates.PAGE);
                _shiftOrigin.call(this, newNodeSize);
                this._eventOutput.emit('pageChange', {
                    direction: -1
                });
                this._currentIndex = index;
